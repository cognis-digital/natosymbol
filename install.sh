#!/usr/bin/env sh
# Universal installer for natosymbol. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/natosymbol.git"
echo "Installing natosymbol ..."
